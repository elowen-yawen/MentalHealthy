        ...
        <el-form>
            ...
            <el-form-item label="文章摘要">
             ...
             <el-form-item label=" 标签 ">
                <el-select v-model="formData.tags" placeholder="请选择标签" multiple filterable allow-create style="padding-left: 25px;">
                    <el-option v-for="p in commonTags" :key="p" :value="p" :label="p">{{ p }}</el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="封面图片">
                <el-upload v-model="formData.coverImage" class="upload-demo"
                    action="#" multiple
                    ...
                    <img :src="imgUrl" alt="" v-else style="" class="cover-img">
                    <div class="cover-img" v-if="!imgUrl">
