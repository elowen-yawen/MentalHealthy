    ...
    <div class="home-container">
        <div class="content">
            <div class="text">
                ...
                <p class="description">每个深夜，每个焦虑的时候，我们都在这里</p>
                <div class="hero-actions">
                    <el-button size="large">开始倾诉，获得陪伴</el-button>
                    <el-button size="large" style="color: #fff;background-color: transparent;">记录心情，释放情感</el-button>
                </div>
            </div>
            <div class="robot">
                <img src="@/assets/robot-fill.png" alt="">
            </div>
        </div>
